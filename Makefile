...
deploy-development:
	STAGE=development serverless deploy --verbose --param="base_domain=dev.trade-tariff.service.gov.uk"

deploy-staging:
	STAGE=staging serverless deploy --verbose --param="base_domain=sandbox.trade-tariff.service.gov.uk"
