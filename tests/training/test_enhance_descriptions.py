...
class TestEnhanceDescriptions(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.data = {
    ...
    def test_add_synonyms(self):
        enhance_descriptions = EnhanceDescriptions(
        ...
        expected_data = {
            "12345678": {
                ...
                "ocean crustations",
                "fresh fish raw",
                "ocean crustations shelled",
            },
            "55555555": {"iron ore", "iron ore hematite"},
            "12345374": {"lemon", "lemon citrus lime"},
            "12237940": {
                "This is a long description that wont have the word added because its over one hundred characters length"
            },
            "12237890": {
        ...
        self.assertEqual(
            enhance_descriptions.add_synonyms(self.__class__.data), expected_data
        )
